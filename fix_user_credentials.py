...
# Benerin cara fetch, kasih credentials: 'include' biar Cookies JWT lu dikirim dari Browser ke Backend.
ui_users_code = """
"use client";
...
export default function UsersTab() {
  ...
  const fetchUsers = () => {
    ...
    // KUNCI ERROR-NYA ADA DI SINI:
    // Wajib pake credentials: 'include' buat NextJS Cookie Auth
